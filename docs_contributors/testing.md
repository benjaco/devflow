...
- Portable terminal fixtures cover repeated multi-option menus, fragmented UTF-8/ANSI, asynchronous logger suffixes, actual keystroke forwarding, declined/failed prompt cleanup and no retries after decline. CLI/store/TUI tests cover choice zero, typed/range validation, reconnect, arrow/Enter/Escape, plus virtual-time readiness pause, attempt isolation and operation deadlines.
