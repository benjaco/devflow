...
- database runtime host-port readiness, stale published-port reconciliation, bounded Engine API calls, exec/log-stream cancellation, stdout/stderr log demultiplexing, structured container-create requests, Docker-context precedence, Windows named-pipe client construction, and managed-container service shutdown
