...
- terminal-backed migration confirmation: real stdin terminal detection on every platform, warning retention before asking, accept/decline/handler-rejection/cancellation/no-handler outcomes, process-tree cleanup, large/final partial output and secret-echo suppression. Failed TUI actions must leave task logs visible. See [Prisma confirmation verification](prisma-confirmation-verification.md)
