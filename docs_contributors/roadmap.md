...
2. Watch and graph explainability
...
3. Target-scoped dependencies and doctor
...
4. User adoption docs and examples
...
- Accepted as immediate roadmap input: service lifecycle docs, watch/debug ergonomics, target-scoped dependencies, managed Postgres docs/examples, fixed-port examples, and secret-handling guidance.
