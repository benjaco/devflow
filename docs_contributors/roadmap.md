...
1. Review the adoption corrections after acceptance of item 7 at `36ca7b8`: action listing preserves the watcher across adapter rebuilds, and compact status/run count service nodes; see [compact evidence verification](compact-evidence-verification.md).
